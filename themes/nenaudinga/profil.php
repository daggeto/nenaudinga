...
if ($user->verifyLogin())
{
	...
	<img src="img/stop.png" style="position:relative;top:2px;"/> <b>' . $content->getValue("profil", "iloscWiedzWait") . ':</b> '.$tentego_poczekalnia.'<br />
	<img src="img/newspaper.png" style="position:relative;top:2px;"/> <b>' . $content->getValue("profil", "ostatnia") . ':</b> ';
